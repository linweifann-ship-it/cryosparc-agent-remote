...
def build_dataset_info(
    ...
    dataset = {
        ...
        "psize_A": dataset_info.get("psize_A"),
        "accel_kv": dataset_info.get("accel_kv"),
        "cs_mm": dataset_info.get("cs_mm"),
        "total_dose_e_per_A2": dataset_info.get("total_dose_e_per_A2"),
