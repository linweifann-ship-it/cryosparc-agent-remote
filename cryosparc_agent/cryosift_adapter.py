...
DEFAULT_EVALUATOR = str(PACKAGE_ROOT / "external" / "cryosift" / "cryosift_runner.py")
DEFAULT_WEIGHTS = str(PACKAGE_ROOT / "external" / "cryosift" / "class_labeling" / "final_model" / "final_model_cont.pth")
...
def evaluate_2d_classes_with_cryosift(
    ...
    python_executable = os.getenv("CRYOAGENT_CRYOSIFT_PYTHON", sys.executable)
