...
class JobResultPackageTests(unittest.TestCase):
    ...
    def test_completed_job_returns_model_result_package(self):
        ...
        self.assertEqual(result["workflow_context"]["workflow_index"]["node_count"], 1)
        self.assertEqual(result["workflow_detail_store"]["nodes"][0]["job_type"], "extract_micrographs_multi")
