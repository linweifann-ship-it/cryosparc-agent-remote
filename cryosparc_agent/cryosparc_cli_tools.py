...
CRYOSPARCM = Path(os.getenv("CRYOAGENT_CRYOSPARCM", "/ssd1/linweifan/cryosparc/cryosparc_master/bin/cryosparcm")).expanduser()
CRYOSPARCW = Path(os.getenv("CRYOAGENT_CRYOSPARCW", "/ssd1/linweifan/cryosparc/cryosparc_worker/bin/cryosparcw")).expanduser()
